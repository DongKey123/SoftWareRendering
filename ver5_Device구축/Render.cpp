...
void ShowInfo()
{
	...
	// Today's Topic.
	{
		...
		char* msg =
			"1.기본프레임웍을 구축합니다.\n"
			"2.SW 렌더링 디바이스(Device) 를 생성합니다.\n"
			"3.Idle 시간에 렌더링을 수행합니다.\n"
			"4.Swap(Flipping) chain 을 구현합니다.";
		DrawText(x, y, RGB(255, 255, 255), msg);
	}
	...
	int x = 300, y = 300;
	static int cnt = 0;
	DrawText(x, y, RGB(255, 255, 0), "Hello, Device!!    cnt=%08d", ++cnt);

	y += 14;
	y += 14;
	DrawText(x, y, RGB(255, 0, 255), "* B3Yena 클래스 버전 *");
