...
enum B3YENAPOOL {
	...
	B3YPOOL_MANAGED,		//자동관리 : 비디오 - 시스템 혼용. , 디바이스로스트 자동적으로 해결하기위해
...
public:
	...
	// 렌더링 상태 변화 조절.
	int SetRenderState(B3YRENDERSTATETYPE state, DWORD value);		//상태 지정.
	void GetRenderState(B3YRENDERSTATETYPE state, DWORD* value);	//지정 상태 얻기.
